CREATE TABLE [dbo].[Match] (
    ...
    [HomeTeamTBC]   VARCHAR (50)     COLLATE Latin1_General_CI_AI NULL,
    [AwayTeamTBC]   VARCHAR (50)     COLLATE Latin1_General_CI_AI NULL,
    [Description]   VARCHAR (50)     COLLATE Latin1_General_CI_AI NULL,
