...
#End Region
		...
		Public Shared Sub SendEmailConfirmation(ByVal UserCompetitionID As Guid)
			...
			If Not IsNothing(objUserCompetition) Then
				...
				strBody.Append("            Your account is now active; you can access it by visiting <a href='").Append(CommonMethods.CurrentURLRoot).Append("'>www.predictathon.co.uk</a> and entering the login details below.").AppendLine()
		...
		Public Shared Sub SendPasswordResetEmail(ByVal User As PredictathonModel.User)
			...
			strBody.Append("            <br /><br />").AppendLine()
			strBody.Append("            Please visit <a href='").Append(CommonMethods.CurrentURLRoot).Append("'>www.predictathon.co.uk</a> and log in. You can change your password via the 'Edit User' option.").AppendLine()
			strBody.Append("            <br /><br />").AppendLine()
		...
		Protected Shared Sub SendPredictionEmailReminder(ByVal UserOverduePredictions As List(Of PredictathonModel.UserOverduePredictionsGet_Result))
            ...
            If objUser IsNot Nothing Then
                ...
                strBody.Append("            </table>").AppendLine()
                strBody.Append("            <br /><br />").AppendLine()
                strBody.Append("            Please visit <a href='").Append(CommonMethods.CurrentURLRoot).Append("'>www.predictathon.co.uk</a> and log in to register your predictions.").AppendLine()
                strBody.Append("            <br /><br />").AppendLine()
