<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UserLeagueTable.ascx.vb" Inherits="Predictathon.UserControls.User.UserLeagueTable" %>
<div class="GridTitle">
    <asp:Hyperlink ID="hypGridTitle" runat="server" />
</div>
<nug:GridView ID="gvCompetitionUserLeagueTable" runat="server" AutoGenerateColumns="false" GridLines="None" AllowPaging="false" CssClass="GridView NoBorder" DataKeyNames="TeamID"
