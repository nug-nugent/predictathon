<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PredictableMatches.ascx.vb" Inherits="Predictathon.UserControls.Statistics.PredictableMatches" %>
<div class="GridTitle">
    <asp:Label ID="lblGridTitle" runat="server" Text="Predictable Matches" />
</div>
