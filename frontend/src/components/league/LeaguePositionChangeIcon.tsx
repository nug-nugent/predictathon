...
// Shows how a user's league position has moved over the current match week - mirrors the legacy
...
// when there's no previous position to compare against (e.g. the competition's first match week, or
// the table's been date-filtered so no comparison was requested).
